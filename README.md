# finder — a Model Meets Reality starter
...
> Surface candidate instances and state what would show a missed one.

And when a claim comes due:

> Did an instance surface later that this model should have found?
...
python -m suites.new_model my-model --kind finder \
